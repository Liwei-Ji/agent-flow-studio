...
export function Input({ data, selected }: NodeProps<Node<BaseNodeData>>) {
  return (
    ...
    >
      ...
      <Handle type="source" position={Position.Right} className="w-4 h-4 bg-zinc-400 border-2 border-zinc-800 hover:scale-125 hover:bg-zinc-400 transition-transform" />
    </div>
  );
}
